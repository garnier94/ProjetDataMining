...
Nous souhaitons prévoir la consommation en éléctricité de l'année 2008 aux Etats-Unis à partir des données recoltées au court des années 2004 à 2007. Nous concentrerons nos efforts sur la zone 2 du jeu de données fourni. 
...
plot(data$date,data$Zone2, type='l', xlab="", ylab="", main="Consommation éléctrique de la zone 2")
...
#acf(res.detude, lag.max = 9*24)
#pacf(res.detude, lag.max = 9*24)
```
