...
**??On peut un modèle additif pour l'écart avec un modèle multiplicatif. ??**

Nous obtenons pour la prévision sur 2017, un RMSE de 0.50 par station pour le premier, et de 0.48 pour le second, qui semble donc meilleur.

Notons que ce RMSE n'est pas exactement comparable aux modèles suivants , puisque qu'il ne tient pas compte du regroupement par districts. Par manque de temps, nous n'avons pas pu tous les modèles avec la même fonction objectif pour comparer, mais nous y travaillons.
...
Les modèles statistiques de prévision que nous avons utilisé nous ont permis de comprendre les outils spécifiques aux séries temporelles. 

**FAIRE BILAN SUR LES RESULTATS RMSE**
