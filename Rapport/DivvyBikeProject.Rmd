...
Le format des données est variable au cours des années. Les noms des différents champs, le decoupage temporels, l'organisations des fichier et le format des dates changent souvent. Par ailleurs, la position des stations ainsi que leurs noms peuvent changer d'une année sur l'autre.
